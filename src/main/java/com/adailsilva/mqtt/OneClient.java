...
public class OneClient implements MqttCallbackExtended {

	private final String serverURI;
	private MqttClient client;
	private final MqttConnectOptions mqttOptions;

	public OneClient(String serverURI, String usuario, String senha) {
	...
	public synchronized void publicar(String topic, byte[] payload, int qos, boolean retained) {
		try {
			if (client.isConnected()) {
				...
				System.out.println(String.format("Tópico %s publicado. Tamanho Payload: %d Bytes.", topic, payload.length));
			} else {
